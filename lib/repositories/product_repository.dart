...
class ProductRepository {
  ...
  Future<Result<List<ProductModel>>> getProducts(String ownerId) =>
      _api.get('/products', (j) => (j as List).map((e) => ProductModel.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  Future<Result<ProductModel>> createProduct(ProductModel product) =>
      _api.post('/products/create', product.toJson(), (j) => ProductModel.fromJson(j as Map<String, dynamic>));
